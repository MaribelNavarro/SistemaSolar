...
/*
 * Este programa sirve de introducción para el manejo de estas
 * entradas deben impulsar en el juego.
 * Recuerda que la clase SimpleApplication proporsiona un
 * "inputManager"
 */
...
public class UserInput extends SimpleApplication{
    ...
    //Los triggers son los objetos que representan las entradas fisicas de los clicks o joystick
    ...
    //Aqui se declara la geometria para que los listeners puedan tener accesso al objeto
    ...
    public void simpleInitApp() {
        ...
        //Se modificó la posición en donde se define del objeto box01_geom
    ...
    //Analiza cuál es la diferencia entre los dos tipos de listener
    private final ActionListener actionListener = new ActionListener(){
        @Override
        public void onAction(String name, boolean isPressed, float tpf) {
            //En este método es donde se definira las condiciones que dictaran la acción
